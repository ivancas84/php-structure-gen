...
class GenSql_mappingField extends GenerateEntity{
...
";
      ...
      case \$p.'" . $field->getName() . "_ym': return \"DATE_FORMAT({\$t}." . $field->getName() . ", '%Y-%m')\";
      case \$p.'" . $field->getName() . "_y': return \"DATE_FORMAT({\$t}." . $field->getName() . ", '%Y')\";
";  
        break;
      }
    }
...
";
  ...
  protected function label(){
    require_once("sql/method/_mappingField/_MappingFieldLabel.php");
    $gen = new GenSql_mappingField_label($this->getEntity());
